      ...
      <Card className="p-0 w-[241.6px] h-[366px]">
        ...
        >
          <div className="relative w-full h-full">
            ...
            />
            <div className="w-[41.6px] h-[33.6px] absolute top-[250px] left-[98px] text-[23.68px] [font-family:'FONTSPRING_DEMO_-_Breul_Grotesk_A_ExtraLight-Regular',Helvetica] font-normal text-black text-center">
              {card.score}{" "}
            </div>
